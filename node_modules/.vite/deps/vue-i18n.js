import { Ft as onMounted, Kn as ref, L as Text, M as Fragment, Mn as effectScope, Nn as getCurrentScope, Rn as isRef, U as computed, Vn as onScopeDispose, Yn as shallowRef, et as createVNode, gn as watch, nt as defineComponent, pt as h, ut as getCurrentInstance$1, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-D4M2X7UN.js";
...
function resolveFormatLocale(context, key, locale, formats, missingWarn, fallbackWarn, type) {
	...
	for (let i = 0; i < locales.length; i++) {
		...
		if (locale !== targetLocale && isTranslateFallbackWarn(fallbackWarn, key)) onWarn(getWarnMessage$1(type === "datetime format" ? CoreWarnCodes.FALLBACK_TO_DATE_FORMAT : CoreWarnCodes.FALLBACK_TO_NUMBER_FORMAT, {
			key,
			target: targetLocale
		}));
...
function getCurrentInstance() {
	return mirroredCurrentInstance ?? getCurrentInstance$1();
}
	...
	return {
		beforeCreate() {
			...
			if (options.i18n) {
				...
				if (this === this.$root) this.$i18n = mergeToGlobal(vuei18n, options);
				else {
